...
class BotCommandProcess(
    ...
    fun banKeyword(groupId: Long, role: String, id: Long): String {
        if (permissionsManager.isAdmin(role, id)) {
            oneBotConfigRepository.checkThenSave(OneBotConfig(null, "banKeywordGroup", groupId.toString()))
    ...
    fun banStudy(groupId: Long, role: String, id: Long): String {
        if (permissionsManager.isAdmin(role, id)) {
            oneBotConfigRepository.checkThenSave(OneBotConfig(null, "banStudy", groupId.toString()))
